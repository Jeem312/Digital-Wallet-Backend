...
router.patch("/status/:id", user_controller_1.userController.updateAccountStatus);
router.patch("/role/:id", (0, checkAuth_1.checkAuth)("admin"), user_controller_1.userController.updateUserRole);
router.patch("/agentApproval", user_controller_1.userController.updateAgentApprovalStatus);
